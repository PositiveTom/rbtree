...
MainWindow::MainWindow(QWidget *parent) :
    ...
    connect(ui->btn_z_minus, &QPushButton::clicked, this, &MainWindow::on_btn_z_minus_clicked);
    connect(ui->btn_z_plus, &QPushButton::clicked, this, &MainWindow::on_btn_z_plus_clicked);
    connect(ui->btnClear, &QPushButton::clicked, this, &MainWindow::on_btnClear_clicked);
    connect(ui->btnTest, &QPushButton::clicked, this, &MainWindow::on_btnTest_clicked);
    connect(ui->rbtn_AVL, &QRadioButton::clicked, this, &MainWindow::on_rbtn_AVL_clicked);
    connect(ui->rbtn_RB, &QRadioButton::clicked, this, &MainWindow::on_rbtn_RB_clicked);
    connect(ui->rbtn_S, &QRadioButton::clicked, this, &MainWindow::on_rbtn_S_clicked);
